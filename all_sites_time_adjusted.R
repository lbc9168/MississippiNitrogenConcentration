...
MIZZ_HE.lm = with(MIZZ_HE[MIZZ_HE$NP_3mAvg != 0,], lm(log(N_Conc) ~ log(N_Price) + log(Flow) + log(CSratio) + log(NP_3mAvg)+ as.factor(Month)))
summary(MIZZ_HE.lm)
...
MSSP_CL.lm = with(MSSP_CL[MSSP_CL$NP_3mAvg != 0,], lm(log(N_Conc) ~ log(N_Price) + log(Flow) + log(CSratio) + log(NP_3mAvg)+ as.factor(Month)))
summary(MSSP_CL.lm)
...
MSSP_GR.lm = with(MSSP_GR[MSSP_GR$NP_3mAvg != 0,], lm(log(N_Conc) ~ log(N_Price) + log(Flow) + log(CSratio) + log(NP_3mAvg)+ as.factor(Month)))
summary(MSSP_GR.lm)
...
MSSP_OUT.lm = with(MSSP_OUT[MSSP_OUT$NP_3mAvg != 0,], lm(log(N_Conc) ~ log(N_Price) + log(Flow) + log(CSratio) + log(NP_3mAvg)+ as.factor(Month)))
summary(MSSP_OUT.lm)
...
MSSP_TH.lm = with(MSSP_TH[MSSP_TH$NP_3mAvg != 0,], lm(log(N_Conc) ~ log(N_Price) + log(Flow) + log(CSratio) + log(NP_3mAvg)+ as.factor(Month)))
summary(MSSP_TH.lm)
...
OHIO_GRCH.lm = with(OHIO_GRCH[OHIO_GRCH$NP_3mAvg != 0,], lm(log(N_Conc) ~ log(N_Price) + log(Flow) + log(CSratio) + log(NP_3mAvg)+ as.factor(Month)))
